...
registerStripeWebhookRawRoute(app, {
  getStripe,
  getDb: () => db,
...
const CONTRACT_BODIES: Record<ContractLang, Record<string, { title: string; body: string }>> = {
  ...
  fr: {
    deposit: {
      title: 'Accord d\'acompte',
      body: 'Le présent instrument contraignant confirme la réservation formelle du Chef-d\'oeuvre « {{piece.title}} » (N° de série : {{piece.serial_id}}).\n\nPar la signature du présent accord, le Client reconnaît son engagement à acquérir l\'actif susmentionné pour une valorisation totale de {{piece.valuation}} EUR.\n\nUn acompte d\'engagement non remboursable de {{depositAmount}} EUR ({{depositPct}} % de la valorisation totale) est requis pour initier la phase de production sur mesure et sécuriser l\'actif au sein de l\'Antonio Bellanova Vault.\n\nÀ réception des fonds, l\'Atelier entame la réalisation artisanale de la pièce. La propriété demeure à l\'Atelier jusqu\'au règlement final.\n\nSTRUCTURE DE PAIEMENT\nLe présent accord fait partie d\'une transaction structurée composée d\'un accord d\'acompte et d\'un règlement final via séquestre.\nUn acompte non remboursable, généralement de 40 à 50 % du montant total (dans cette transaction : {{depositPct}} %), est payable directement sur le compte professionnel du vendeur et sert à lancer la production et sécuriser les matériaux.\nLe solde restant, généralement de 50 à 60 %, doit être versé sur le compte de séquestre désigné avant la livraison.\n\nTRAITEMENT DU SÉQUESTRE\nSéquestre : notaire / prestataire de séquestre agréé / service de séquestre bancaire désigné (à nommer par écrit avant le transfert final).\nCoordonnées du compte séquestre : communiquées par écrit avant l\'échéance (emplacement réservé tant que non désigné).\nL\'agent séquestre agit en tant que tiers indépendant.\nLes fonds sont conservés de manière neutre jusqu\'à la réalisation des conditions de libération.\n\nCONDITIONS DE LIBÉRATION\nLes fonds en séquestre sont libérés uniquement après livraison réussie ou remise en main propre et confirmation de l\'acheteur.\nLa confirmation peut être documentée par une confirmation écrite et/ou un document de remise signé.\n\nTRANSFERT DE PROPRIÉTÉ\nLa propriété reste au vendeur jusqu\'au paiement intégral et à la libération des fonds séquestrés.\n\nLIVRAISON ET REMISE\nLa livraison s\'effectue par remise en main propre ou expédition sécurisée.\nEn cas d\'expédition, celle-ci doit être intégralement assurée et assurée par un prestataire logistique spécialisé en biens de grande valeur.\nLe lieu de livraison doit être convenu par écrit.\n\nRETARD ET RUPTURE CONTRACTUELLE\nSi l\'acheteur ne règle pas le solde dans les délais, l\'acompte reste acquis au vendeur.\nSi le vendeur ne livre pas conformément au présent accord, l\'acheteur peut réclamer les fonds séquestrés selon les conditions de séquestre.\n\nVÉRIFICATION D\'IDENTITÉ ET CONFORMITÉ\nAvant finalisation, l\'acheteur doit fournir une pièce d\'identité/passeport valide, un justificatif de domicile et, si requis, un justificatif de provenance des fonds.\nLa transaction est traitée conformément à la législation allemande applicable en matière de lutte contre le blanchiment (AML/KYC).\n\nRECOMMANDATION DE REVENTE : Le Client est invité à réaliser toute revente future de cet actif via la plateforme Antonio Bellanova Vault. La revente sur plateforme garantit la mise à jour du Registre, l\'émission d\'un nouveau Certificat d\'Authenticité, la continuité des garanties et la préservation du Prestige Score et de l\'Historique de Service. Ces avantages ne s\'appliquent pas aux transferts hors plateforme.',
    },
    invoice: {
      title: 'Facture finale',
      body: 'FACTURE FINALE D\'ACQUISITION\n\nLa présente facture constitue le règlement final du Chef-d\'oeuvre « {{piece.title}} ».\n\nValorisation totale : {{piece.valuation}} EUR\nAcompte versé : {{depositPaid}} EUR\nSolde restant : {{balanceDue}} EUR\n\nLe présent accord fait partie d\'une transaction structurée composée d\'un accord d\'acompte et d\'un règlement final via séquestre.\n\nSTRUCTURE DE PAIEMENT\nL\'acompte déjà versé (généralement 40 à 50 %) est non remboursable et a été payé sur le compte professionnel du vendeur pour le démarrage de la production et l\'allocation des matériaux.\nLe solde restant (généralement 50 à 60 %) doit être versé sur le compte de séquestre désigné avant la livraison.\n\nTRAITEMENT DU SÉQUESTRE\nSéquestre : notaire / prestataire de séquestre agréé / service de séquestre bancaire désigné (à nommer par écrit avant le transfert final).\nCoordonnées du compte séquestre : communiquées par écrit avant l\'échéance (emplacement réservé tant que non désigné).\nL\'agent séquestre agit en tant que tiers indépendant.\nLes fonds sont conservés de manière neutre jusqu\'à la réalisation des conditions de libération.\n\nCONDITIONS DE LIBÉRATION\nLes fonds en séquestre sont libérés uniquement après livraison réussie ou remise en main propre et confirmation de l\'acheteur.\nLa confirmation peut être documentée par une confirmation écrite et/ou un document de remise signé.\n\nTRANSFERT DE PROPRIÉTÉ\nLe transfert de propriété intervient uniquement après paiement intégral et libération des fonds séquestrés.\n\nLIVRAISON ET REMISE\nLa livraison s\'effectue par remise en main propre ou expédition sécurisée.\nEn cas d\'expédition, celle-ci doit être intégralement assurée et assurée par un prestataire logistique spécialisé en biens de grande valeur.\nLe lieu de livraison doit être convenu par écrit.\n\nRETARD ET RUPTURE CONTRACTUELLE\nSi l\'acheteur ne règle pas le solde, l\'acompte versé reste acquis au vendeur.\nSi le vendeur ne livre pas selon les conditions convenues, l\'acheteur peut réclamer les fonds séquestrés selon les conditions de séquestre.\n\nVÉRIFICATION D\'IDENTITÉ ET CONFORMITÉ\nAvant finalisation, l\'acheteur doit fournir une pièce d\'identité/passeport valide, un justificatif de domicile et, si requis, un justificatif de provenance des fonds.\nLa transaction est traitée conformément à la législation allemande applicable en matière de lutte contre le blanchiment (AML/KYC).\n\nLe paiement est exigible sous 14 jours pour initier la phase de libération du séquestre et de livraison. Le transfert de propriété est exécuté après libération réussie du séquestre.',
    },
  ...
  es: {
    deposit: {
      title: 'Acuerdo de depósito',
      body: 'Este instrumento vinculante confirma la reserva formal de la Obra Maestra identificada como «{{piece.title}}» (Serie: {{piece.serial_id}}).\n\nAl firmar este acuerdo, el Cliente reconoce el compromiso de adquisición del activo mencionado por una valoración total de {{piece.valuation}} EUR.\n\nSe requiere un depósito de compromiso no reembolsable de {{depositAmount}} EUR ({{depositPct}} % de la valoración total) para iniciar la fase de producción a medida y asegurar el activo dentro de Antonio Bellanova Vault.\n\nTras la recepción de fondos, el Atelier iniciará la realización artesanal de la pieza. La propiedad permanece en el Atelier hasta la liquidación final.\n\nESTRUCTURA DE PAGO\nEste acuerdo forma parte de una transacción estructurada compuesta por un acuerdo de depósito y una liquidación final vía escrow.\nUn depósito no reembolsable de normalmente 40-50 % del importe total (en esta transacción: {{depositPct}} %) se paga directamente a la cuenta comercial del vendedor y se utiliza para iniciar la producción y asegurar materiales.\nEl saldo restante de normalmente 50-60 % debe transferirse a la cuenta de escrow designada antes de la entrega.\n\nGESTIÓN DE ESCROW (TREUHAND)\nDepositario escrow: notario / proveedor de escrow autorizado / entidad bancaria designada (se nombrará por escrito antes de la transferencia final).\nDatos de la cuenta escrow: se facilitarán por escrito antes del vencimiento (marcador de posición hasta su designación).\nEl agente de escrow actúa como un tercero independiente.\nLos fondos se mantienen de forma neutral hasta que se cumplan las condiciones de liberación.\n\nCONDICIONES DE LIBERACIÓN\nLos fondos escrow se liberan únicamente después de la entrega exitosa o la entrega personal y la confirmación del comprador.\nLa confirmación puede documentarse mediante confirmación escrita y/o documento de entrega firmado.\n\nTRANSFERENCIA DE PROPIEDAD\nLa propiedad permanece en el vendedor hasta completar el pago total y liberar los fondos escrow.\n\nENTREGA Y RECEPCIÓN\nLa entrega se realiza mediante entrega personal o transporte seguro.\nSi se envía, debe estar totalmente asegurada y gestionada por un proveedor logístico especializado en bienes de alto valor.\nEl lugar de entrega debe acordarse por escrito.\n\nMORA E INCUMPLIMIENTO\nSi el comprador no paga el saldo restante, el depósito permanece en poder del vendedor.\nSi el vendedor no entrega conforme a lo pactado, el comprador tiene derecho a reclamar los fondos escrow conforme a las condiciones de escrow.\n\nVERIFICACIÓN DE IDENTIDAD Y CUMPLIMIENTO\nAntes de la finalización, el comprador debe aportar documento de identidad/pasaporte, comprobante de domicilio y prueba de fondos cuando sea requerido.\nLa transacción se procesa conforme a la normativa alemana aplicable de prevención de blanqueo de capitales (AML/KYC).\n\nRECOMENDACIÓN DE REVENTA: Se recomienda al Cliente realizar cualquier futura reventa de este activo a través de la plataforma Antonio Bellanova Vault. La reventa en plataforma garantiza actualización del Registro, emisión de un nuevo Certificado de Autenticidad, continuidad de beneficios de garantía y preservación del Prestige Score y del historial de servicio. Estos beneficios no aplican a transferencias fuera de la plataforma.',
    },
    invoice: {
      title: 'Factura final',
      body: 'FACTURA FINAL DE ADQUISICIÓN\n\nEsta factura representa la liquidación final de la Obra Maestra «{{piece.title}}».\n\nValoración total: {{piece.valuation}} EUR\nDepósito pagado: {{depositPaid}} EUR\nSaldo restante: {{balanceDue}} EUR\n\nEste acuerdo forma parte de una transacción estructurada compuesta por un acuerdo de depósito y una liquidación final vía escrow.\n\nESTRUCTURA DE PAGO\nEl depósito ya pagado (normalmente 40-50 %) no es reembolsable y fue abonado a la cuenta comercial del vendedor para iniciar producción y asegurar materiales.\nEl saldo restante (normalmente 50-60 %) debe transferirse a la cuenta de escrow designada antes de la entrega.\n\nGESTIÓN DE ESCROW (TREUHAND)\nDepositario escrow: notario / proveedor de escrow autorizado / entidad bancaria designada (se nombrará por escrito antes de la transferencia final).\nDatos de la cuenta escrow: se facilitarán por escrito antes del vencimiento (marcador de posición hasta su designación).\nEl agente de escrow actúa como un tercero independiente.\nLos fondos se mantienen de forma neutral hasta que se cumplan las condiciones de liberación.\n\nCONDICIONES DE LIBERACIÓN\nLos fondos escrow se liberan únicamente después de la entrega exitosa o la entrega personal y la confirmación del comprador.\nLa confirmación puede documentarse mediante confirmación escrita y/o documento de entrega firmado.\n\nTRANSFERENCIA DE PROPIEDAD\nLa transferencia de propiedad se realiza únicamente tras el pago completo y la liberación de los fondos escrow.\n\nENTREGA Y RECEPCIÓN\nLa entrega se realiza mediante entrega personal o transporte seguro.\nSi se envía, debe estar totalmente asegurada y gestionada por un proveedor logístico especializado en bienes de alto valor.\nEl lugar de entrega debe acordarse por escrito.\n\nMORA E INCUMPLIMIENTO\nSi el comprador no paga el saldo restante, el depósito ya pagado permanece en poder del vendedor.\nSi el vendedor no entrega conforme a lo pactado, el comprador tiene derecho a reclamar los fondos escrow conforme a las condiciones de escrow.\n\nVERIFICACIÓN DE IDENTIDAD Y CUMPLIMIENTO\nAntes de la finalización, el comprador debe aportar documento de identidad/pasaporte, comprobante de domicilio y prueba de fondos cuando sea requerido.\nLa transacción se procesa conforme a la normativa alemana aplicable de prevención de blanqueo de capitales (AML/KYC).\n\nEl pago vence en un plazo de 14 días para iniciar la fase de liberación de escrow y entrega. La transferencia de propiedad se ejecutará tras la liberación exitosa del escrow.',
    },
  ...
  pt: {
    deposit: {
      title: 'Acordo de depósito',
      body: 'Este instrumento vinculativo confirma a reserva formal da Obra-Prima identificada como "{{piece.title}}" (Série: {{piece.serial_id}}).\n\nAo celebrar este acordo, o Cliente reconhece o compromisso de aquisição do ativo acima referido por uma avaliação total de {{piece.valuation}} EUR.\n\nÉ exigido um depósito de compromisso não reembolsável de {{depositAmount}} EUR ({{depositPct}}% da avaliação total) para iniciar a fase de produção personalizada e assegurar o ativo no Antonio Bellanova Vault.\n\nApós o recebimento dos fundos, o Atelier iniciará a realização artesanal da peça. A propriedade permanece com o Atelier até à liquidação final.\n\nESTRUTURA DE PAGAMENTO\nEste acordo faz parte de uma transação estruturada composta por acordo de depósito e liquidação final via escrow.\nUm depósito não reembolsável de tipicamente 40-50% do valor total (nesta transação: {{depositPct}}%) é pago diretamente para a conta empresarial do vendedor e usado para iniciar a produção e garantir materiais.\nO saldo remanescente de tipicamente 50-60% deve ser transferido para a conta escrow designada antes da entrega.\n\nPROCESSO DE ESCROW (TREUHAND)\nEntidade escrow: notário / prestador licenciado de escrow / serviço bancário de escrow designado (a ser nomeado por escrito antes da transferência final).\nDados da conta escrow: serão fornecidos por escrito antes do vencimento (placeholder até nomeação).\nO agente de escrow atua como terceiro independente.\nOs fundos são mantidos de forma neutra até que as condições de liberação sejam cumpridas.\n\nCONDIÇÕES DE LIBERAÇÃO\nOs fundos escrow só são liberados após entrega bem-sucedida ou entrega pessoal e confirmação do comprador.\nA confirmação pode ser documentada por confirmação escrita e/ou comprovativo de entrega assinado.\n\nTRANSFERÊNCIA DE PROPRIEDADE\nA propriedade permanece com o vendedor até à conclusão do pagamento integral e à liberação dos fundos escrow.\n\nENTREGA E RECEÇÃO\nA entrega ocorre por entrega pessoal ou transporte seguro.\nEm caso de envio, deve ser totalmente segurado e realizado por operador logístico especializado em bens de alto valor.\nO local de entrega deve ser acordado por escrito.\n\nMORA E INCUMPRIMENTO\nSe o comprador não pagar o saldo remanescente, o depósito permanece com o vendedor.\nSe o vendedor não entregar conforme acordado, o comprador pode reclamar os fundos escrow nos termos do escrow.\n\nVERIFICAÇÃO DE IDENTIDADE E COMPLIANCE\nAntes da conclusão, o comprador deve apresentar documento de identidade/passaporte válido, comprovativo de morada e comprovativo de origem dos fundos, quando exigido.\nA transação é processada em conformidade com a legislação alemã aplicável de prevenção ao branqueamento de capitais (AML/KYC).\n\nRECOMENDAÇÃO DE REVENDA: Recomenda-se ao Cliente que realize qualquer revenda futura deste ativo através da plataforma Antonio Bellanova Vault. A revenda na plataforma assegura atualização do Registro, emissão de novo Certificado de Autenticidade, continuidade dos benefícios de garantia e preservação do Prestige Score e histórico de serviço. Estes benefícios não se aplicam a transferências fora da plataforma.',
    },
    invoice: {
      title: 'Fatura final',
      body: 'FATURA FINAL DE AQUISIÇÃO\n\nEsta fatura representa a liquidação final da Obra-Prima "{{piece.title}}".\n\nAvaliação total: {{piece.valuation}} EUR\nDepósito pago: {{depositPaid}} EUR\nSaldo remanescente: {{balanceDue}} EUR\n\nEste acordo faz parte de uma transação estruturada composta por acordo de depósito e liquidação final via escrow.\n\nESTRUTURA DE PAGAMENTO\nO depósito já pago (tipicamente 40-50%) é não reembolsável e foi pago para a conta empresarial do vendedor para início da produção e alocação de materiais.\nO saldo remanescente (tipicamente 50-60%) deve ser transferido para a conta escrow designada antes da entrega.\n\nPROCESSO DE ESCROW (TREUHAND)\nEntidade escrow: notário / prestador licenciado de escrow / serviço bancário de escrow designado (a ser nomeado por escrito antes da transferência final).\nDados da conta escrow: serão fornecidos por escrito antes do vencimento (placeholder até nomeação).\nO agente de escrow atua como terceiro independente.\nOs fundos são mantidos de forma neutra até que as condições de liberação sejam cumpridas.\n\nCONDIÇÕES DE LIBERAÇÃO\nOs fundos escrow só são liberados após entrega bem-sucedida ou entrega pessoal e confirmação do comprador.\nA confirmação pode ser documentada por confirmação escrita e/ou comprovativo de entrega assinado.\n\nTRANSFERÊNCIA DE PROPRIEDADE\nA transferência de propriedade ocorre apenas após pagamento integral e liberação dos fundos escrow.\n\nENTREGA E RECEÇÃO\nA entrega ocorre por entrega pessoal ou transporte seguro.\nEm caso de envio, deve ser totalmente segurado e realizado por operador logístico especializado em bens de alto valor.\nO local de entrega deve ser acordado por escrito.\n\nMORA E INCUMPRIMENTO\nSe o comprador não pagar o saldo remanescente, o depósito já pago permanece com o vendedor.\nSe o vendedor não entregar conforme acordado, o comprador pode reclamar os fundos escrow nos termos do escrow.\n\nVERIFICAÇÃO DE IDENTIDADE E COMPLIANCE\nAntes da conclusão, o comprador deve apresentar documento de identidade/passaporte válido, comprovativo de morada e comprovativo de origem dos fundos, quando exigido.\nA transação é processada em conformidade com a legislação alemã aplicável de prevenção ao branqueamento de capitais (AML/KYC).\n\nO pagamento vence em 14 dias para iniciar a fase de liberação de escrow e entrega. A transferência de propriedade será executada após a liberação bem-sucedida do escrow.',
    },
  ...
  ar: {
    deposit: {
      title: 'اتفاقية الدفعة المقدمة',
      body: 'تؤكد هذه الوثيقة الملزمة الحجز الرسمي للتحفة \"{{piece.title}}\" (الرقم التسلسلي: {{piece.serial_id}}).\n\nبإبرام هذه الاتفاقية، يقر العميل بالتزامه باقتناء الأصل المذكور بقيمة إجمالية قدرها {{piece.valuation}} يورو.\n\nيلزم دفع دفعة مقدمة غير قابلة للاسترداد بقيمة {{depositAmount}} يورو ({{depositPct}}% من القيمة الإجمالية) لبدء مرحلة الإنتاج المخصص وتأمين الأصل داخل Antonio Bellanova Vault.\n\nعند استلام الأموال، يبدأ الأتيليه بتنفيذ القطعة يدويًا. تبقى الملكية لدى الأتيليه حتى التسوية النهائية.\n\nهيكل الدفع\nهذه الاتفاقية جزء من معاملة منظمة تتكون من اتفاقية دفعة مقدمة وتسوية نهائية عبر حساب ضمان.\nتدفع دفعة مقدمة غير قابلة للاسترداد بنسبة 40-50% عادةً من إجمالي المبلغ (في هذه المعاملة: {{depositPct}}%) مباشرة إلى حساب أعمال البائع وتستخدم لبدء الإنتاج وتأمين المواد.\nيجب تحويل الرصيد المتبقي بنسبة 50-60% عادةً إلى حساب الضمان المعين قبل التسليم.\n\nإجراءات الضمان (Treuhand)\nجهة الضمان: كاتب عدل / مزود ضمان مرخص / جهة ضمان مصرفية معينة (يتم تحديدها كتابيًا قبل التحويل النهائي).\nبيانات حساب الضمان: يتم تقديمها كتابيًا قبل تاريخ الاستحقاق (حقل مؤقت حتى التحديد).\nيتصرف وكيل الضمان كطرف ثالث مستقل.\nتُحفظ الأموال بشكل محايد حتى تحقق شروط الإفراج.\n\nشروط الإفراج\nلا يتم الإفراج عن أموال الضمان إلا بعد التسليم الناجح أو التسليم الشخصي وتأكيد المشتري.\nيمكن توثيق التأكيد بإقرار خطي و/أو مستند تسليم موقع.\n\nانتقال الملكية\nتبقى الملكية لدى البائع حتى اكتمال السداد الكامل والإفراج عن أموال الضمان.\n\nالتسليم والاستلام\nيتم التسليم عبر تسليم شخصي أو نقل مؤمن.\nفي حال الشحن، يجب أن يكون الشحن مؤمنًا بالكامل ويتم عبر مزود لوجستي متخصص في السلع عالية القيمة.\nيجب الاتفاق على مكان التسليم كتابيًا.\n\nالتأخر والإخلال بالعقد\nإذا أخفق المشتري في دفع الرصيد المتبقي، تبقى الدفعة المقدمة لدى البائع.\nإذا أخفق البائع في التسليم وفقًا للاتفاق، يحق للمشتري المطالبة بأموال الضمان وفق شروط الضمان.\n\nالتحقق من الهوية والامتثال\nقبل الإتمام، يجب على المشتري تقديم هوية/جواز سفر ساري، وإثبات عنوان، وإثبات مصدر الأموال عند الاقتضاء.\nتتم المعاملة وفقًا لقوانين مكافحة غسل الأموال الألمانية المعمول بها (AML/KYC).\n\nتوصية إعادة البيع: يُنصح العميل بإتمام أي إعادة بيع مستقبلية لهذا الأصل عبر منصة Antonio Bellanova Vault. تضمن إعادة البيع عبر المنصة تحديث السجل، وإصدار شهادة أصالة جديدة، واستمرارية مزايا الضمان، والحفاظ على درجة Prestige وسجل الخدمة. لا تنطبق هذه المزايا على التحويلات خارج المنصة.',
    },
    invoice: {
      title: 'الفاتورة النهائية',
      body: 'الفاتورة النهائية للاقتناء\n\nتمثل هذه الفاتورة التسوية النهائية للتحفة \"{{piece.title}}\".\n\nالقيمة الإجمالية: {{piece.valuation}} يورو\nالدفعة المقدمة المسددة: {{depositPaid}} يورو\nالرصيد المتبقي: {{balanceDue}} يورو\n\nهذه الاتفاقية جزء من معاملة منظمة تتكون من اتفاقية دفعة مقدمة وتسوية نهائية عبر حساب ضمان.\n\nهيكل الدفع\nالدفعة المقدمة المسددة (عادةً 40-50%) غير قابلة للاسترداد وقد دُفعت إلى حساب أعمال البائع لبدء الإنتاج وتخصيص المواد.\nيجب تحويل الرصيد المتبقي (عادةً 50-60%) إلى حساب الضمان المعين قبل التسليم.\n\nإجراءات الضمان (Treuhand)\nجهة الضمان: كاتب عدل / مزود ضمان مرخص / جهة ضمان مصرفية معينة (يتم تحديدها كتابيًا قبل التحويل النهائي).\nبيانات حساب الضمان: يتم تقديمها كتابيًا قبل تاريخ الاستحقاق (حقل مؤقت حتى التحديد).\nيتصرف وكيل الضمان كطرف ثالث مستقل.\nتُحفظ الأموال بشكل محايد حتى تحقق شروط الإفراج.\n\nشروط الإفراج\nلا يتم الإفراج عن أموال الضمان إلا بعد التسليم الناجح أو التسليم الشخصي وتأكيد المشتري.\nيمكن توثيق التأكيد بإقرار خطي و/أو مستند تسليم موقع.\n\nانتقال الملكية\nلا يتم انتقال الملكية إلا بعد إتمام السداد الكامل والإفراج عن أموال الضمان.\n\nالتسليم والاستلام\nيتم التسليم عبر تسليم شخصي أو نقل مؤمن.\nفي حال الشحن، يجب أن يكون الشحن مؤمنًا بالكامل ويتم عبر مزود لوجستي متخصص في السلع عالية القيمة.\nيجب الاتفاق على مكان التسليم كتابيًا.\n\nالتأخر والإخلال بالعقد\nإذا أخفق المشتري في دفع الرصيد المتبقي، تبقى الدفعة المقدمة المسددة لدى البائع.\nإذا أخفق البائع في التسليم وفقًا للاتفاق، يحق للمشتري المطالبة بأموال الضمان وفق شروط الضمان.\n\nالتحقق من الهوية والامتثال\nقبل الإتمام، يجب على المشتري تقديم هوية/جواز سفر ساري، وإثبات عنوان، وإثبات مصدر الأموال عند الاقتضاء.\nتتم المعاملة وفقًا لقوانين مكافحة غسل الأموال الألمانية المعمول بها (AML/KYC).\n\nيستحق الدفع خلال 14 يومًا لبدء مرحلة الإفراج من الضمان والتسليم. يتم نقل الملكية بعد الإفراج الناجح من الضمان.',
    },
...
stripeWebhookSendMail = sendMail;
...
app.post("/api/marketplace/reserve", requireAuth, requireAdmin, async (req, res) => {
  try {
    const sessionUid = Number(getSessionUserId(req) || 0);
    if (!sessionUid || Number.isNaN(sessionUid) || sessionUid === GUEST_USER_ID) {
      return res.status(403).json({ error: "Bitte mit einem Admin-Konto anmelden.", code: "ADMIN_REQUIRED" });
    }
    const { masterpieceId } = req.body || {};
    const mid = Number(masterpieceId);
    if (!mid || Number.isNaN(mid)) return res.status(400).json({ error: "masterpieceId ist erforderlich." });
    const piece = await (await db.prepare("SELECT * FROM masterpieces WHERE id = ?")).get(mid) as any;
    if (!piece) return res.status(404).json({ error: "Stück nicht gefunden." });
    if (piece.status && !["available", "reserved_client"].includes(String(piece.status))) {
      return res.status(400).json({ error: "Stück kann aktuell nicht reserviert werden." });
    }
    if (String(piece.status) === "reserved_client") {
      return res.json({ success: true, already_reserved: true, masterpieceId: mid });
    }
    await logMasterpieceStatusChange(mid, "reserved_client", sessionUid);
    await (await db.prepare("UPDATE masterpieces SET status = 'reserved_client' WHERE id = ?")).run(mid);
    await updateProvenance(mid, "vip_event", `Reserved by admin ${sessionUid}.`);
    broadcast({ type: "PIECE_RESERVED", masterpieceId: mid, userId: sessionUid });
...
function generateAdminContractContent(contractType: string, client: any, project: any, masterpiece: any): string {
  ...
  const valuation = masterpiece?.valuation ? `${Number(masterpiece.valuation).toLocaleString('en-GB')} EUR` : '—';
...
<p><strong>Gemstones:</strong> ${gemstones}</p>
<p><strong>Weight:</strong> ${weight}</p>
${valuation !== '—' ? `<p><strong>Valuation:</strong> ${valuation}</p>` : ''}
<p style="margin-top:24px;">This document was generated by the Antonio Bellanova Vault and is linked to the project (Vault ID: ${vaultId}) and the client.</p>
<p style="margin-top:16px;font-size:12px;color:#666;">${companyBlock}</p>
<p style="font-size:11px;color:#999;">Governing law: Germany. Jurisdiction: Cologne.</p>
</div>`;
}
...
app.post("/api/admin/documents/generate", requireAuth, requireAdmin, async (req, res) => {
  ...
  const CERTIFICATE_TYPES: Record<string, string> = {
    ...
    provenance: 'Certificate of Provenance',
    collector: 'Collector Certificate',
  ...
  if (document_type === 'contract') {
    ...
    content = content.replace('Purchase Agreement', 'Final Invoice');
    const ins = await (await db.prepare(`
      INSERT INTO contracts (user_id, masterpiece_id, type, doc_ref, content, status)
      VALUES (?, ?, ?, ?, ?, 'draft')
...
<p><strong>Serial number:</strong> ${serialId}</p>
<p><strong>Project:</strong> ${project?.project_name || piece?.title || '—'}</p>
<p><strong>Client:</strong> ${client.name}</p>
<p><strong>Asset:</strong> ${piece?.title || project?.project_name || '—'}</p>
<p><strong>Certificate ID:</strong> ${certId}</p>
<p>This certificate attests to the authenticity and ownership of the stated asset.</p>
<p style="font-size:12px;color:#666;">Juwelen & Schmuckatelier Antonio Bellanova · Cologne · VAT ID: ${UST_IDNR}</p>
</div>`;
...
app.post("/api/resale/complete", async (req, res) => {
  ...
  const certHtml = generateLuxuryDocument("Certificate of Authenticity", certContent, buyer, piece, { docRef: certId, title: "Certificate of Authenticity", registryId: regId, registryUrl: `/registry/masterpiece/${piece.id}`, certificateVerifyUrl: `${BASE_URL}/verify/${certId}`, lang: OFFICIAL_CONTRACT_LANG });
  await (await db.prepare("INSERT INTO certificates (masterpiece_id, owner_id, cert_id, content, signature, blockchain_hash) VALUES (?, ?, ?, ?, ?, ?)")).run(
...
app.post("/api/admin/fractional/initialize", async (req, res) => {
  ...
  for (const share of shares) {
    ...
    const html = generateLuxuryDocument("Fractional Ownership Agreement", content, user, piece, { docRef, title: "Fractional Ownership Agreement", lang: OFFICIAL_CONTRACT_LANG });
